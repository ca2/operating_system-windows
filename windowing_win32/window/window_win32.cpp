...
LRESULT CALLBACK __window_procedure(HWND hwnd, UINT message, WPARAM wparam, LPARAM lparam)
{
   ...
   else if (::is_set(puserinteraction))
   {
      ...
      auto pmessage = pwindow->get_message((enum_message)message, wparam, (iptr) lparam);
...
::pointer<::message::message>window::get_message(const ::atom & atom, wparam wparam, lparam lparam)
{
   ...
   case ::message::e_prototype_key:
   {
      ...
      //void key::set(oswindow oswindow, ::windowing::window * pwindow, const ::atom & atom, wparam wparam, ::lparam lparam)
      {
        ...
        // ::user::message::set(oswindow, pwindow, atom, wparam, lparam);
         ...
         pmessage->m_nRepCnt = LOWORD(lparam);
   ...
   case ::message::e_prototype_scroll:
   {
      ...
      pmessage->m_ecommand = (enum_scroll_command)(i16)LOWORD(wparam);
   ...
   case ::message::e_prototype_mouse:
   {
      ...
      ::ClientToScreen((HWND) pmessage->m_oswindow, (LPPOINT) &pmessage->m_point);
   ...
   case ::message::e_prototype_activate:
   {
      ...
      //{
         ...
         pmessage->m_eactivate = (enum_activate)(LOWORD(wparam));
