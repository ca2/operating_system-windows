...
namespace windows
{
   ...
   HCURSOR create_alpha_icon(::image::image * pimage, bool bIcon, ::i32 xHotSpot, ::i32 yHotSpot)
   {
   ...
   HCURSOR create_alpha_cursor(::image::image * pimage, ::i32 xHotSpot, ::i32 yHotSpot)
   {
   ...
   CLASS_DECL_WINDOWING_WIN32 HBITMAP create_windows_dib(const ::i32_size & size, ::i32 * piScan, ::image32_t ** ppdata)
   {
...
namespace windowing_win32
{
   ...
   HICON windowing::_load_icon(string_array_base & straMatter, const ::scoped_string & scopedstrIcon, ::i32 cx, ::i32 cy)
   {
