...
bool has_autohide_appbar(::u32 edge, const i32_rectangle &mon);
...
namespace windowing_win32
{
   ...
   //   //if (((::windowing_win32::window *)this)->_HWND() == nullptr)
   //   //   return;     // null (unattached) windows are valid

   //   //// check for special wnd??? values
   //   //ASSERT(HWND_TOP == nullptr);       // same as desktop
   //   //if (((::windowing_win32::window *)this)->_HWND() == HWND_BOTTOM)
   //   //{
   //   //}
   //   //else if (((::windowing_win32::window *)this)->_HWND() == HWND_TOPMOST)
   //   //{
   //   //}
   //   //else if (((::windowing_win32::window *)this)->_HWND() == HWND_NOTOPMOST)
   //   //{
   //   //}
   //   //else
   //   //{
   //   //   // should be a normal window
   //   //   ASSERT(::IsWindow(((::windowing_win32::window *)this)->_HWND()));
   ...
   //   //dumpcontext << "\nm_oswindow_ = " << ((::windowing_win32::window *)this)->_HWND();

   //   //if (((::windowing_win32::window *)this)->_HWND() == nullptr || ((::windowing_win32::window *)this)->_HWND() == HWND_BOTTOM ||
   //   //   ((::windowing_win32::window *)this)->_HWND() == HWND_TOPMOST || ((::windowing_win32::window *)this)->_HWND() == HWND_NOTOPMOST)
   //   //{
   //   //   // not a normal window - nothing more to dump
   //   //   return;
   //   //}

   //   //if (!::IsWindow(((::windowing_win32::window *)this)->_HWND()))
   //   //{
   //   //   // not a valid window
   ...
   //   ////auto puserinteraction = psystem->ui_from_handle(((::windowing_win32::window *)this)->_HWND());
   ...
   //   ////if (::GetWindowLong(((::windowing_win32::window *)this)->_HWND(), GWL_STYLE) & WS_CHILD)
   //   ////   dumpcontext << "\nid = " << __get_dialog_control_id(((::windowing_win32::window *)this)->_HWND());
   ...
   void window::prio_install_message_routing(::channel *pchannel)
   {
      ...
      USER_MESSAGE_LINK(::user::e_message_paint, pchannel, this, &window::on_message_paint);
      ...
      if (emessageTaskbarCreated != ::user::e_message_undefined)
      {

         USER_MESSAGE_LINK(emessageTaskbarCreated, pchannel, this, &window::_001OnTaskbarCreated);
   ...
   //void window::_set_oswindow(const ::operating_system::window & operatingsystemwindow)
   //{
   ...
   void window::destroy()
   {
      ...
      if (WNDPROC(::GetWindowLongPtr(hwnd, GWLP_WNDPROC)) == pfnWndProc)
      {
         ...
         if (pfnSuper != nullptr)
         {
            ...
            ::SetWindowLongPtr(hwnd, GWLP_WNDPROC, reinterpret_cast<iptr>(pfnSuper));
   ...
   void window::_create_window()
   {
      ...
      // 1. Force message queue creation
      MSG msg;
      ...
      system()->acme_windowing()->add_window(this);
      ...
      bool bUnicode = ::IsWindowUnicode(::as_HWND(this->operating_system_window())) != false;
   ...
   void window::window_update_screen()
   {
      ...
      if (m_pgraphicsgraphics)
      {
         ...
         if (edisplayOutput != edisplayDesign)
         {
            ...
            //user_interaction()->send_message(::user::e_message_show_window, ::is_screen_visible(edisplayDesign) ? 1 : 0);
   ...
   //      //}
   //      }
   //      else if (pmessage->m_eusermessage == WM_SETTINGCHANGE && strLparamString == "ImmersiveColorSet")
   //      {
   ...
   //   //::i32 iSmallIconCx = ::GetSystemMetrics(SM_CXSMICON);
   //   //::i32 iSmallIconCy = ::GetSystemMetrics(SM_CYSMICON);
   //   //::i32 iIconCx = ::GetSystemMetrics(SM_CXICON);
   //   //::i32 iIconCy = ::GetSystemMetrics(SM_CXICON);
   //   ::i32 iSmallIconCx = 256;
   //   ::i32 iSmallIconCy = 256;
   //   ::i32 iIconCx = 256;
   //   ::i32 iIconCy = 256;
   ...
   //window *
   //   oswindow_get(Display * pdisplay, Window window, Visual * pvisual, ::i32 iDepth, ::i32 iScreen, Colormap colormap)
   //{
   ...
   //::i32 window::x_change_property(Atom property, Atom type, ::i32 format, ::i32 mode, const ::u8 * data,
   //   ::i32 nelements)
   //{
   ...
   //   WNDPROC pfnWndProc = WNDPROC(::GetWindowLongPtr(::as_HWND(this->operating_system_window()), GWLP_WNDPROC));

   //   if (WNDPROC(::GetWindowLongPtr(::as_HWND(this->operating_system_window()), GWLP_WNDPROC)) == pfnWndProc)
   //   {
   ...
   //         ::SetWindowLongPtr(::as_HWND(this->operating_system_window()), GWLP_WNDPROC, reinterpret_cast<iptr>(pfnSuper));
   ...
   void window::set_parent(::windowing::window *pwindowParent)
   {
      ...
      if (::is_set(pwindowParent))
      {
         ...
         hwndParent = as_HWND(pwindowParent->operating_system_window());
   ...
   bool window::_configure_window_unlocked(const class ::zorder &zorder, const ::user::activation &useractivation,
   ...
   void window::full_screen(const ::i32_rectangle &rectangle)
   {
      ...
      //::i32 iMonitor = best_xinerama_monitor(puserinteraction, rectangle, rBest);
   ...
   //   ::i32 nCmdShow = windows_show_window(edisplay, useractivation);

   //   if(!::XXXShowWindow(::as_HWND(this->operating_system_window()), nCmdShow))
   //   {
   ...
   //
   //      GetWindowRect(::as_HWND(this->operating_system_window()), (RECT *)&rectangleWindowCurrent);
   //
   //      //               }
   //                     //else
   //                     //{
   ...
   //bool window::on_set_window_position(const class ::zorder& zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, const ::user::e_activation& useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, bool bShow, bool bHide)
   //{
...
#undef SET_WINDOW_POS_LOG
   ...
   public:
      ...
      void a_task_bar_question(HWND hwnd, bool bSecondary)
      {
         ...
         if (GetWindowRect(hwnd, &r))
         {
            ...
            auto ptaskbar = create_newø<task_bar>();
   ...
   bool window::__set_window_position(const class ::zorder &zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy,
                                      const ::user::activation &useractivation, bool bNoZorder, bool bNoMove,
                                      bool bNoSize, bool bShow, bool bHide, ::u32 nOverrideFlags)
   {
      ...
      information() << "::SetWindowPos " << ::i32_rectangle_dimension(x, y, cx, cy);
      ...
      //   ::i32 iBottomTaskBar = ptaskbar->m_rectangle.bottom;

      //   ::i32 iBottomMonitor = ptaskbar->m_pmonitor->m_rectangle.bottom;
   ...
   ////bool window::_set_window_position(const class ::zorder& zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, const ::user::e_activation& useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, bool bShow, bool bHide, ::u32 nOverrideFlags)
   ...
   //   ::ScreenToClient(::as_HWND(this->operating_system_window()), &point);
   ...
   //   App(puserinteraction).window_set_mouse_cursor(puserinteraction->_HWND(), 0);
   ...
   bool window::get_window_placement(WINDOWPLACEMENT *puserinteractionpl)
   {
      ...
      return ::GetWindowPlacement(::as_HWND(this->operating_system_window()), puserinteractionpl) != false;
   ...
   bool window::set_window_placement(const WINDOWPLACEMENT *puserinteractionpl)
   {
      ...
      return ::SetWindowPlacement(::as_HWND(this->operating_system_window()), puserinteractionpl) != false;
   ...
   void window::_set_foreground_window_unlocked(::user::activation_token *puseractivationtoken)
   {
      ...
      //if (!pActiveWnd || !((pActiveWnd)->_HWND() == _HWND() || ::IsChild((pActiveWnd)->_HWND(), _HWND())))
      //{
   ...
   void window::_001OnPaint(::message::message *pmessage)
   {
      ...
      HDC hdc = ::BeginPaint(::as_HWND(this->operating_system_window()), &paint);
      ...
      ::EndPaint(::as_HWND(this->operating_system_window()), &paint);
   ...
   //   //return psystem->ui_from_handle(::SetParent(::as_HWND(this->operating_system_window()), pWndNewParent->_HWND()));
   ...
   //   //if (!::IsWindow(::as_HWND(this->operating_system_window())))
   //   //{
   ...
   //   //if (::as_HWND(this->operating_system_window()); == nullptr)
   //   //{
   ...
   //   //HWND hwndParent = ::GetParent(::as_HWND(this->operating_system_window()));
   ...
   bool window::is_iconic()
   {
      ...
      //else
      {
         ...
         return ::IsIconic(::as_HWND(this->operating_system_window())) != false;
   ...
   ::windowing::window *window::window_get_owner()
   {
      ...
      auto operatingsystemwindow = get_owner_operating_system_window();

      auto pacmewindowingwindow = win32_windowing()->acme_windowing_window(operatingsystemwindow);
   ...
   ::operating_system::window window::get_owner_operating_system_window()
   {
      ...
      HWND hwndOwner = ::GetWindow(::as_HWND(this->operating_system_window()), GW_OWNER);

      if (hwndOwner == nullptr)
      {

         return window_get_parent()->operating_system_window();

      }

      auto operatingsystemwindow = as_operating_system_window(hwndOwner);

      //auto pacmewindowingwindow = system()->acme_windowing()->acme_windowing_window(operatingsystemwindow);
   ...
   void window::set_owner(::windowing::window *pWndNewOwner)
   {
      ...
      if (::is_set(pWndNewOwner))
      {
         ...
         hwndOwner = ::as_HWND(pWndNewOwner->operating_system_window());
   ...
   //{
   //   return ::GetWindowLong(::as_HWND(this->operating_system_window()), nIndex);
   //}

   //::i32 window::set_window_long(::i32 nIndex, ::i32 lValue)
   //{
   //   return ::SetWindowLong(::as_HWND(this->operating_system_window()), nIndex, lValue);
   //}
   ...
   //   return ::GetWindowLongPtr(::as_HWND(this->operating_system_window()), nIndex);
   ...
   //   return ::SetWindowLongPtr(::as_HWND(this->operating_system_window()), nIndex, lValue);
   ...
   { return this == nullptr ? nullptr : ::as_HWND(this->operating_system_window());; }*/
   //bool window::operator==(const window & wnd) const
   //{

   //   return (((window *)&wnd)->_HWND()) == ((window *)this)->_HWND();
   ...
   //   return (::u32)::GetWindowLong(::as_HWND(this->operating_system_window()), GWL_STYLE);
   ...
   void window::default_message_handler(::message::message *pmessage)
   {
      ...
      HWND hwnd = ::as_HWND(pmessage->m_operatingsystemwindow);

      UINT message = pmessage->m_eusermessage;
   ...
   //   return ModifyStyleEx(::as_HWND(this->operating_system_window()), dwRemove, dwAdd, nFlags);
   ...
   lresult window::send_message(::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam)
   {
      ...
      return ::SendMessage(::as_HWND(this->operating_system_window()), eusermessage, wparam, lparam);
   ...
   void window::post_message(::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam)
   {
      ...
      BOOL bOk = ::PostMessage(hwnd, eusermessage, wparam, lparam);
   ...
   void window::set_window_text(const ::scoped_string &scopedstr)
   {
      ...
      if (!::SendMessageTimeoutW(::as_HWND(this->operating_system_window()), WM_SETTEXT, 0, (LONG_PTR)pwszText, SMTO_ABORTIFHUNG, 500, &lresult))
      {
   ...
   ::string window::get_window_text()
   {
      ...
      if (!::SendMessageTimeoutW(::as_HWND(this->operating_system_window()), WM_GETTEXTLENGTH, 0, 0, SMTO_ABORTIFHUNG, 90, &lresult))
      {
      ...
      if (!::SendMessageTimeoutW(::as_HWND(this->operating_system_window()), WM_GETTEXT, (lparam)p, lresult + 1, SMTO_ABORTIFHUNG, 90, &lresult))
      {
   ...
   //   return ::GetWindowTextLength(::as_HWND(this->operating_system_window()));
   ...
   //{
   //   ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
   //   ::DragAcceptFiles(::as_HWND(this->operating_system_window()), bAccept);
   //}
   ...
   ::u32 window::ArrangeIconicWindows()
   {
      ...
      ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      return ::ArrangeIconicWindows(::as_HWND(this->operating_system_window()));
   ...
   //   //ASSERT(::IsWindow(::as_HWND(this->operating_system_window()))); return ::SetWindowRgn(::as_HWND(this->operating_system_window()),hRgn,bRedraw);
   ...
   //   //ASSERT(::IsWindow(::as_HWND(this->operating_system_window())) && hRgn != nullptr); return ::GetWindowRgn(::as_HWND(this->operating_system_window()),hRgn);
   ...
   //   bool bOk = ::BringWindowToTop(::as_HWND(this->operating_system_window())) != false;
   ...
   //         ::set_window_position(::as_HWND(this->operating_system_window()), (HWND)e_zorder_top, 0, 0, 0, 0, SWP_NOMOVE | SWP_NOSIZE | SWP_SHOWWINDOW);

   //         //::set_window_position(::as_HWND(this->operating_system_window()),(HWND)e_zorder_top,0,0,0,0,SWP_NOMOVE | SWP_NOSIZE | SWP_SHOWWINDOW);

   //         //::set_window_position(::as_HWND(this->operating_system_window()),(HWND)e_zorder_top_most,0,0,0,0,SWP_NOMOVE | SWP_NOSIZE | SWP_SHOWWINDOW);
   ...
   //void window::MapWindowPoints(::user::window * puserinteractionTo, ::i32_point * pPoint, ::u32 nCount)
   //{

   //   ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));

   //   ::MapWindowPoints(::as_HWND(this->operating_system_window()), puserinteractionTo->_HWND(), pPoint, nCount);
   ...
   //{
   //   ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
   //   ::MapWindowPoints(::as_HWND(this->operating_system_window()), puserinteractionTo->_HWND(), (::i32_point *)prectangle, 2);
   ...
   {
      ::UpdateWindow(::as_HWND(this->operating_system_window()));
   }
   ...
   {
      ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      ::SendMessage(::as_HWND(this->operating_system_window()), WM_SETREDRAW, bRedraw, 0);
   }
   ...
   bool window::GetUpdateRect(::i32_rectangle *prectangle, bool bErase)
   {
      ...
      ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      RECT r;
      auto bOk = ::GetUpdateRect(::as_HWND(this->operating_system_window()), &r, bErase) != false;
   ...
   ::i32 window::GetUpdateRgn(::draw2d::region *pRgn, bool bErase)
   {
      ...
      //ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      //return ::GetUpdateRgn(::as_HWND(this->operating_system_window()), (HRGN)pRgn->get_os_data(), bErase);
   ...
   {
      ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      ::InvalidateRect(::as_HWND(this->operating_system_window()), nullptr, bErase);
   }
   ...
   {
      ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      ::InvalidateRect(::as_HWND(this->operating_system_window()), (RECT *)rectangle, bErase);
   ...
   void window::InvalidateRgn(::draw2d::region *pRgn, bool bErase)
   {
      ...
      //ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      //::InvalidateRgn(::as_HWND(this->operating_system_window()), (HRGN)pRgn->get_os_data(), bErase);
...

   {
      ...
      ::ValidateRect(::as_HWND(this->operating_system_window()), (RECT *)rectangle);
   ...
   void window::ValidateRgn(::draw2d::region *pRgn)
   {
      ...
      //::ValidateRgn(::as_HWND(this->operating_system_window()), (HRGN)pRgn->get_os_data());
   ...
   void window::ShowOwnedPopups(bool bShow)
   {
      ...
      ::ShowOwnedPopups(::as_HWND(this->operating_system_window()), bShow);
   ...
   bool window::LockWindowUpdate()
   {
      ...
      return ::LockWindowUpdate(::as_HWND(this->operating_system_window())) != false;
   ...
   bool window::RedrawWindow(const ::i32_rectangle &rectangleUpdate, ::draw2d::region *prgnUpdate, ::u32 flags)
   {
      ...
      if (!(_get_ex_style() & WS_EX_LAYERED))
      {
         ...
         ::RedrawWindow(::as_HWND(this->operating_system_window()), nullptr, nullptr, flags);
      ...
      if (flags & RDW_UPDATENOW)
      {
         ...
         //   return ::set_need_redraw(::as_HWND(this->operating_system_window()), pRectUpdate, prgnUpdate == nullptr ? nullptr : (HRGN)prgnUpdate->get_os_data(),
   ...
   bool window::EnableScrollBar(::i32 nSBFlags, ::u32 nArrowFlags)
   {
      ...
      return ::EnableScrollBar(::as_HWND(this->operating_system_window()), nSBFlags, nArrowFlags) != false;
   ...
   //   return ::DrawAnimatedRects(::as_HWND(this->operating_system_window()), idAni, prcFrom, lprcTo) != false;
   ...
   bool window::is_this_enabled()
   {
      ...
      return ::IsWindowEnabled(::as_HWND(this->operating_system_window())) != false;
   ...
   void window::enable_window(bool bEnable)
   {
      ...
      BOOL bStateOk = ::EnableWindow(::as_HWND(this->operating_system_window()), bEnable);
   ...
   //   if (!::IsWindowVisible(::as_HWND(this->operating_system_window())))
   //   {
   ...
   //         HWND hwnd = ::XXXSetFocus(::as_HWND(this->operating_system_window()));
   ...
   //   ::CheckDlgButton(::as_HWND(this->operating_system_window()), nIDButton, nCheck);
   ...
   //   ::CheckRadioButton(::as_HWND(this->operating_system_window()), nIDFirstButton, nIDLastButton, nIDCheckButton);
   ...
   //   return ::DlgDirList(::as_HWND(this->operating_system_window()), pPathSpec, nIDListBox, nIDStaticPath, nFileType);
   ...
   //   return ::DlgDirListComboBox(::as_HWND(this->operating_system_window()), pPathSpec, nIDComboBox, nIDStaticPath, nFileType);
   ...
   //   return ::DlgDirSelectEx(::as_HWND(this->operating_system_window()), pString, nSize, nIDListBox) != false;
   ...
   //   return ::DlgDirSelectComboBoxEx(::as_HWND(this->operating_system_window()), pString, nSize, nIDComboBox) != false;
   ...
   //   *poswindow_ = ::GetDlgItem(((window *)this)->_HWND(), (::i32)atom);
   ...
   //   return ::GetDlgItemInt(((window *)this)->_HWND(), nID, pTrans, bSigned);
   ...
   //   return ::GetDlgItemText(((window *)this)->_HWND(), nID, pStr, nMaxCount);
   ...
   //   return psystem->ui_from_handle(::GetNextDlgGroupItem(((window *)this)->_HWND(), pWndCtl->_HWND(), bPrevious));
   ...
   //   return psystem->ui_from_handle(::GetNextDlgTabItem(((window *)this)->_HWND(), pWndCtl->_HWND(), bPrevious));
   ...
   //{
   //   ASSERT(::IsWindow(((window *)this)->_HWND()));
   //   return ::IsDlgButtonChecked(((window *)this)->_HWND(), nIDButton);
   //}
   ...
   //   return ::SendDlgItemMessage(((window *)this)->_HWND(), message, message, wParam, lParam);
   ...
   //{
   //   ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
   //   ::SetDlgItemInt(::as_HWND(this->operating_system_window()), nID, nValue, bSigned);
   //}
   //void window::SetDlgItemText(::i32 nID, const ::scoped_string & scopedstrString)

   //{
   //   ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
   //   ::SetDlgItemTextW(::as_HWND(this->operating_system_window()), nID, wstring(pszString));
   ...
   //   //ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
   //   //return ::ScrollWindowEx(::as_HWND(this->operating_system_window()), dx, dy, pRectScroll, lpRectClip,
   ...
   //{
   //   ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
   //   ::ShowScrollBar(::as_HWND(this->operating_system_window()), nBar, bShow);
   //}
   //::user::interaction * window::ChildWindowFromPoint(const ::i32_point & point)
   //{
   //   ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));

   //   return  psystem->ui_from_handle(::ChildWindowFromPoint(::as_HWND(this->operating_system_window()), i32_point));
   ...
   //   return  psystem->ui_from_handle(::ChildWindowFromPointEx(::as_HWND(this->operating_system_window()), point, nFlags));
   ...
   //   return ::FlashWindow(::as_HWND(this->operating_system_window()), bInvert) != false;
   ...
   //   return ::ChangeClipboardChain(::as_HWND(this->operating_system_window()), oswindow_Next) != false;
   ...
   //   return ::SetClipboardImpacter(::as_HWND(this->operating_system_window()));
   ...
   //   if (!::OpenClipboard(::as_HWND(this->operating_system_window())))
   //   {
   ...
   void window::HideCaret()
   {
      ...
      ::HideCaret(::as_HWND(this->operating_system_window()));
   ...
   void window::ShowCaret()
   {
      ...
      ::ShowCaret(::as_HWND(this->operating_system_window()));
   ...
   //   return ::SetWindowContextHelpId(((window *)this)->_HWND(), dwContextHelpId) != false;
   ...
   //   return ::GetWindowContextHelpId(((window *)this)->_HWND());
   ...
   void window::_001OnWindowPosChanged(::message::message *pmessage)
   {
      ...
      if (::IsIconic(::as_HWND(this->operating_system_window())))
      {
      ...
      else if (::IsZoomed(::as_HWND(this->operating_system_window())))
      {
   ...
   //      return Default();
   //   }
   //   void window::OnNcLButtonDblClk(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcLButtonDown(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcLButtonUp(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcMButtonDblClk(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcMButtonDown(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcMButtonUp(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcMouseMove(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   ...
   //      Default();
   //   }
   //   void window::OnNcRButtonDblClk(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcRButtonDown(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnNcRButtonUp(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   ...
   //      Default();
   //   }
   //   void window::OnLButtonDblClk(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnLButtonDown(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnLButtonUp(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnMButtonDblClk(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnMButtonDown(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnMButtonUp(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   ...
   //      return (::i32)Default();
   //   }
   //   void window::OnMouseMove(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //
   //   bool window::OnMouseWheel(::u32, ::i16, const i32_point&)
   //   {
   //
   //      return Default() != false;
   //
   ...
   //      return Default();
   //   }
   //   void window::OnRButtonDblClk(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnRButtonDown(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   //   void window::OnRButtonUp(::u32, const i32_point&)
   //   {
   //      Default();
   //   }
   ...
   //      Default();
   //   }
   //   void window::OnAskCbFormatName(__in ::u32 nMaxCount, __out_ecount_z(nMaxCount) ::i8 * pszName)
   //   {
   //      (nMaxCount);
   //      if (nMaxCount > 0)
   //      {
   ...
   //      Default();
   //   }
   //   void window::OnSizing(::u32, ::i32_rectangle *)
   //   {
   //      Default();
   //   }
   //   void window::OnMoving(::u32, ::i32_rectangle *)
   //   {
   //      Default();
   //   }
   ...
   void window::BeginModalState()
   {
      ...
      ::EnableWindow(::as_HWND(this->operating_system_window()), false);
   ...
   void window::EndModalState()
   {
      ...
      ::EnableWindow(::as_HWND(this->operating_system_window()), true);
   ...
   */
   ...
   {
      ASSERT(::IsWindow(::as_HWND(this->operating_system_window())));
      ::CloseWindow(::as_HWND(this->operating_system_window()));
   }
   ...
   bool window::OpenIcon()
   {
      ...
      return ::OpenIcon(::as_HWND(this->operating_system_window())) != false;
   ...
   void window::track_mouse_hover()
   {
      ...
      tme.hwndTrack = ::as_HWND(this->operating_system_window());
      TrackMouseEvent(&tme);
...
/*   void window::_001DeferPaintLayeredWindowBackground(::image::image * pimage)
   ...
   */
   ...
   //   hr = ::RegisterDragDrop(::as_HWND(this->operating_system_window()), pimpl);
   ...
   void window::show_task(bool bShowTaskBar)
   {
      ...
      if (SUCCEEDED(hr) && SUCCEEDED(hr = tasklist->HrInit()))
      {
         ...
         if (bShowTaskBar)
         {
            ...
            hr = tasklist->AddTab(::as_HWND(this->operating_system_window()));
         ...
         else
         {
            ...
            tasklist->DeleteTab(::as_HWND(this->operating_system_window()));
   ...
   /*bool window::set_window_position(class ::user::zorder zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, ::u32 nFlags)
   {
      ...
      if (!(GetExStyle() & WS_EX_LAYERED))
      {
         ...
         if (!::set_window_position(::as_HWND(this->operating_system_window()), zorder, x, y, cx, cy, nFlags))
         {
...
*/
   ...
   //      lresult = ::DefWindowProcW(m_pacmewindowingwindow, (::u32)pmessage->m_eusermessage.long_long(), pmessage->m_wparam, pmessage->m_lparam);

   //   }
   //   else
   //   {

   //      lresult = ::CallWindowProc(pfnWndProc, m_pacmewindowingwindow, (::u32)pmessage->m_eusermessage.long_long(), pmessage->m_wparam, pmessage->m_lparam);
   ...
   //         ::GetClientRect(::as_HWND(this->operating_system_window()), rectangleX);
   //         ::i32_rectangle rectangleWindow;
   //         ::GetWindowRect(::as_HWND(this->operating_system_window()), rectangleWindow);
   //         ::i32_rectangle rectangleRegion;
   //         HRGN hrgn = CreateRectRgn(0, 0, 0, 0);
   //         ::i32 regionType = ::GetWindowRgn(::as_HWND(this->operating_system_window()), hrgn);
   //         if (regionType != ERROR)
   //         {
   ...
   //         ::GetWindowPlacement(::as_HWND(this->operating_system_window()), &wp);
   //         bool bZoomed = ::IsZoomed(::as_HWND(this->operating_system_window())) != false;
   //         bool bIconic = ::IsIconic(::as_HWND(this->operating_system_window())) != false;
   //      }
   ...
   //
   //            ::ClientToScreen(::as_HWND(this->operating_system_window()), &pmouse->m_point);
   //
   //         }
   //
   //         if (message == ::user::e_message_left_button_down)
   ...
   bool window::window_rectangle(::i32_rectangle *prectangle)
   {
      ...
      if (!::GetWindowRect(::as_HWND(this->operating_system_window()), &rectangle))
      {
   ...
   bool window::rectangle(::i32_rectangle *prectangle)
   {
      ...
      if (!::GetClientRect(::as_HWND(this->operating_system_window()), &rectangle))
      {
   ...
   void window::non_top_most_upper_window_rects(::i32_rectangle_array_base &recta)
   {
      ...
      for (iFind--; iFind >= 0; iFind--)
      {
         ...
         ::i32 iExStyle = GetWindowLong(hwnd, GWL_EXSTYLE);
      ...
      while (ptask->should_run())
      {
         ...
         if (!rectangleX.contains(pointMouseMove))
         {
            ...
            if (m_bTrackMouseLeave)
            {
               ...
               user_interaction()->post_message(::user::e_message_mouse_leave);
         ...
         user_interaction()->send_message(::user::e_message_mouse_move, 0, lparam);
   ...
   void window::_001OnCreate(::message::message *pmessage)
   {
      ...
      if (puserinteraction)
      {
         ...
         if (puserinteraction->is_message_only_window() || puserinteraction->cast<
                ::windowing_win32::system_interaction>())
         {
   ...
   ::f32 window::get_dpi_for_window()
   {
      ...
      return (::f32)::get_dpi_for_window(operatingsystemwindow);
   ...
   bool window::on_window_procedure(::lresult &lresult, ::u32 message, ::wparam wparam, ::lparam lparam)
   {
      ...
      if (message == ::user::e_message_create)
      {
         ...
         informationf("::user::e_message_create");
      ...
      else if (message == ::user::e_message_show_window)
      {
         ...
         informationf("::user::e_message_show_window");

      }
      else if (message == ::user::e_message_left_button_double_click)
      {

         information() << "::user::e_message_left_button_double_click";

      }
      else if (message == ::user::e_message_activate)
      {
      ...
      //if (pimpl)
      {
         ...
         else if (message == ::user::e_message_timer)
         {
            ...
            //   call_message_handler(::user::e_message_mouse_move, 0, lparam);
...
//            lresult = ::DefWindowProcW(hwnd, message, wparam, lparam);
   ...
   void window::_raw_client_to_screen(::i32_point &point)
   {
      ...
      ::ClientToScreen(::as_HWND(this->operating_system_window()), (POINT *)&point);
   ...
   void window::_raw_screen_to_client(::i32_point &point)
   {
      ...
      ::ScreenToClient(::as_HWND(this->operating_system_window()), (POINT *)&point);
