...
namespace draw2d_gdiplus
{
   ...
   */
   ...
   bool pen::create(::draw2d::graphics * pdraw2dgraphics, ::i8 iCreate)
   {

      if (m_epen == ::draw2d::e_pen_brush)
      {

         m_ppen = ___new Gdiplus::Pen(m_pbrush->get_os_data <Gdiplus::Brush *>(pdraw2dgraphics), (Gdiplus::REAL) m_dWidth);
