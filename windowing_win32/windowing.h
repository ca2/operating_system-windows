...
//#endif
      ...
      virtual void __synthesizes_creates_styles(::acme::user::interaction * pinteraction, ::u32 & nExStyle, ::u32 & nStyle);
      ...
      virtual int_bool point_is_window_origin(::i32_point ptHitTest,
                                              const ::operating_system::window &operatingsystemwindowExclude, ::i32 iMargin);

      //virtual void top_windows_by_z_order(hwnd_array & a);


      virtual bool is_window(::acme::windowing::window * pacmewindowingwindow) override;
      ...
      virtual wstring _windows_register_window_class(::u32 nClassStyle, const WCHAR * pwszClassName, HCURSOR hCursor = 0, HBRUSH hbrBackground = 0, HICON hIcon = 0);
      ...
      //
      virtual wstring _windows_calc_icon_window_class(::acme::user::interaction* pinteraction, ::u32 dwDefaultStyle, const ::scoped_string & scopedstrMatter) override;
      ...
      ::i32 system_metrics_get_cx_icon_spacing() override;
      ::i32 system_metrics_get_cy_icon_spacing() override;
      ::i32 system_metrics_get_cx_icon() override;
      ::i32 system_metrics_get_cy_icon() override;
      ::i32 system_metrics_get_cy_caption() override;
