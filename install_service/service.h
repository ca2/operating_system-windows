...
::i32 affinity_mask_to_string(__int64, TCHAR **);
::i32 affinity_string_to_mask(TCHAR *, __int64 *);
unsigned long priority_mask();
::i32 priority_constant_to_index(unsigned long);
unsigned long priority_index_to_constant(::i32);
...
::i32 set_service_dependencies(const TCHAR *, SC_HANDLE, TCHAR *);
::i32 get_service_dependencies(const TCHAR *, SC_HANDLE, TCHAR **, unsigned long *, ::i32);
::i32 get_service_dependencies(const TCHAR *, SC_HANDLE, TCHAR **, unsigned long *);
::i32 set_service_description(const TCHAR *, SC_HANDLE, TCHAR *);
::i32 get_service_description(const TCHAR *, SC_HANDLE, unsigned long, TCHAR *);
::i32 get_service_startup(const TCHAR *, SC_HANDLE, const QUERY_SERVICE_CONFIG *, unsigned long *);
::i32 get_service_username(const TCHAR *, const QUERY_SERVICE_CONFIG *, TCHAR **, size_t *);
::i32 pre_install_service(::i32, TCHAR **);
::i32 pre_erase_service(::i32, TCHAR **);
::i32 pre_edit_service(::i32, TCHAR **);
::i32 install_service(nssm_service_t *);
::i32 erase_service(nssm_service_t *);
::i32 edit_service(nssm_service_t *, bool);
::i32 control_service(unsigned long, ::i32, TCHAR **);
void set_service_recovery(nssm_service_t *);
::i32 monitor_service(nssm_service_t *);
::i32 start_service(nssm_service_t *);
::i32 stop_service(nssm_service_t *, unsigned long, bool, bool);
void CALLBACK end_service(void *, ::u8);
void throttle_restart(nssm_service_t *);
::i32 await_shutdown(nssm_service_t *, TCHAR *, unsigned long);
