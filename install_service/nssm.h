...
/*
  ...
  ::times have elapsed since startup.  Override in registry.
*/
...
/*
  How many ::times to wait for the application to die after posting to
...
/* Margin of error for service status wait hints in ::times. */
...
/* How many ::times to wait before updating service status. */
