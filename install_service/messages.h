...
// MessageText:
//
// The service is configured with a 64-bit file i32_size threshold for file
...
// MessageText:
//
// Service %1 ran for less than %2 ::times.
// Restart will be delayed by %3 ::times.
//
...
// MessageText:
//
// The registry value %2, used to specify the minimum number of ::times which must elapse before service %1 is considered to have started successfully, was not of type REG_DWORD.  The default time of %3 ::times will be used.
//
...
// MessageText:
//
// The registry value %2, used to specify the maximum number of ::times to wait for service %1 to stop after posting a ::user::e_message_close message to windows managed by the application, was not of type REG_DWORD.  The default time of %3 ::times will be used.
//
...
// MessageText:
//
// The registry value %2, used to specify the maximum number of ::times to wait for service %1 to stop after posting a ::user::e_message_quit message to the message queues of threads managed by the application, was not of type REG_DWORD.  The default time of %3 ::times will be used.
//
...
// MessageText:
//
// %1 has waited %3 of %5 ::times for the %2 service to exit.
// Next update in %4 ::times.
//
...
// MessageText:
//
// The minimum number of ::times which must pass before service %1 is considered to have been started successfully is set to %2.  Access to the Windows service control manager is blocked until the service updates its status, therefore %3 will wait a maximum of %4 ::times before reporting the service's state as running.  Service restart throttling will be enforced if the service runs for less than the full %2 ::times.
//
...
// MessageText:
//
// The registry value %2, used to specify the number of ::times by which restarts of service %1 will be delayed, was not of type REG_DWORD.
...
// MessageText:
//
// Restart of service %1 will be delayed by %2 ::times.
//
