...
// MessageText:
//
// The registry value %2, used to specify the maximum number of ::times to wait for service %1 to stop after posting a MESSAGE_CLOSE message to windows managed by the application, was not of type REG_DWORD.  The default time of %3 ::times will be used.
//
