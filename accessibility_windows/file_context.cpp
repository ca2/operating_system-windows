...
CLASS_DECL_ACME_WINDOWS bool read_resource_as_memory(memory & m, HINSTANCE hinst, DWORD nID, const_char_pointer pszType, character_count iReadAtMostByteCount = -1);
...
//#endif
   ...
   //   if((::u32)status.m_attribute != wAttr && !(wAttr & readOnly))
   //   {
   //      if(!SetFileAttributes((::i8 *)pszFileName,(::u32)status.m_attribute))
   ...
   //   if((wAttr = GetFileAttributes((::i8 *)pszFileName)) == (::u32)-1L)
