...
namespace windowing_win32
{
   ...
   void display::enum_display_monitors()
   {
      ...
      for (::collection::index iMonitor = 0; iMonitor < m_monitorinfoa.get_count(); iMonitor++)
      {
         ...
         auto pmonitor = create_newø < ::windowing_win32::monitor >();
   ...
   void display::_get_monitor(::int_rectangle_array & rectaMonitor, ::int_rectangle_array & rectaIntersect, const i32_rectangle & rectangleParam)
   {
...
#define ZONEING_COMPARE ::comparison
   ...
   ::collection::index display::get_best_monitor(::i32_rectangle * prectangle, const i32_rectangle & rectangleParam, const ::user::activation & useractivation, ::windowing::window * pwindowCursorPosition)
   {
   ...
   ::collection::index display::get_best_workspace(::i32_rectangle * prectangle, const i32_rectangle & rectangleParam, const ::user::activation & useractivation, ::windowing::window * pwindowCursorPosition)
   {
      ...
      if (useractivation & ::user::e_activation_under_mouse_cursor)
      {
         ...
         ::i32_point pointCursor = pwindowCursorPosition->get_cursor_position();
