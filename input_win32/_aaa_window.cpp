...
//      m_window = None;
   ...
   void window::create_window(::windowing::window * pimpl)
   {
      ...
      ::i32 cx = puserinteraction->const_layout().sketch().size().cx;
      ::i32 cy = puserinteraction->const_layout().sketch().size().cy;
   ...
   void window::_001OnTaskbarCreated(::message::message* pmessage)
   {
      ...
      m_pwindow->m_puserinteraction->handle(&topic, nullptr);
...
//
   ...
   bool window::_set_window_position_unlocked(const class ::zorder & zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, const ::user::e_activation & useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, ::e_display edisplay)
   {
...
#undef SET_WINDOW_POS_LOG
   ...
   bool window::__set_window_position(const class ::zorder & zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, const ::user::e_activation & useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, bool bShow, bool bHide, ::u32 nOverrideFlags)
   {
   ...
   //   //m_pwindow->m_puserinteraction->set_position({x, y}, ::user::e_layout_window);
   //   //m_pwindow->m_puserinteraction->set_size({ cx, cy }, ::user::e_layout_window);
...
//   }
   ...
   bool window::post_message(::user::enum_message eusermessage, ::wparam wparam, ::lparam lparam)
   {
   ...
   //   return ::DragDetect(((window *)this)->get_hwnd(), i32_point) != false;
   ...
   //{
   //   ASSERT(::IsWindow(get_hwnd()));
   //   ::MapWindowPoints(get_hwnd(), puserinteractionTo->get_hwnd(), (::i32_point *)prectangle, 2);
   ...
   //   return  psystem->ui_from_handle(::ChildWindowFromPoint(get_hwnd(), i32_point));
...
//         ::i32 regionType = ::GetWindowRgn(get_hwnd(), hrgn);
//         if (regionType != ERROR)
//         {
      ...
      while (ptask->should_run())
      {
         ...
         if (!rectangleX.contains(pointMouseMove))
         {
            ...
            if (m_bTrackMouseLeave)
            {
               ...
               m_pwindow->m_puserinteraction->post_message(::user::e_message_mouse_leave);
         ...
         //pimpl->m_puserinteraction->post_message(::user::e_message_mouse_move, 0, lparam);
         
         pimpl->m_puserinteraction->send_message(::user::e_message_mouse_move, 0, lparam);
...
//         default_message_handler(pmessage);
      ...
      if (m_pwindow->m_puserinteraction)
      {
         ...
         if (m_pwindow->m_puserinteraction->is_message_only_window() || m_pwindow->m_puserinteraction.cast <::windowing_win32::system_interaction >())
         {
   ...
   ::f32 window::get_dpi_for_window()
   {
      ...
      return (::f32) ::get_dpi_for_window(oswindow);
   ...
   void window::window_update_screen_buffer()
   {
      ...
      m_pwindow->m_pgraphics->update_screen();
