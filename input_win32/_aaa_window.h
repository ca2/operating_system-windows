...
//      virtual bool is_child_of(const ::windowing::window * pwindowAscendantCandidate) const override;
      ...
      virtual bool __set_window_position(const class ::zorder& zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, const ::user::e_activation& useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, bool bShow, bool bHide, ::u32 nOverrideFlags = 0);

      bool _set_window_position_unlocked(const class ::zorder & zorder, ::i32 x, ::i32 y, ::i32 cx, ::i32 cy, const ::user::e_activation & useractivation, bool bNoZorder, bool bNoMove, bool bNoSize, ::e_display edisplay) override;
...
//#endif   // WINVER >= 0x0500
      ...
      virtual bool post_message(::user::enum_message eusermessage, ::wparam wparam = {}, ::lparam lparam = {}) override;
