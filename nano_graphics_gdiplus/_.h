...
#if defined(_nano_graphics_gdiplus_project)
#define CLASS_DECL_NANO_GRAPHICS_GDIPLUS  CLASS_DECL_EXPORT
#else
#define CLASS_DECL_NANO_GRAPHICS_GDIPLUS  CLASS_DECL_IMPORT
#endif
...
//CLASS_DECL_NANO_GRAPHICS_GDIPLUS ::particle * user_synchronization();
