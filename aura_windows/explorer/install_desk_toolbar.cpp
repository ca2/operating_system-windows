...
//   //#ifdef _DEBUG
//
//   strPathDll = m_psystem->m_pacmedir->module() / "_desk_tb.dll";
//
//   //#else
//   //
   ...
   //if (SUCCEEDED(hr))
   {
      ...
      //if (SUCCEEDED(hr))
      {
         ...
         //while (iCount > 0)
         {
            ...
            ::windows::registry::key k(HKEY_CURRENT_USER, "Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\Streams\\Desktop", false);
