...
namespace aura_windows
{
   ...
   public:
      ...
      lresult send_message(const ::atom& atom, const ::wparam & wparam = {}, lparam lParam = {}, const ::i32_point& point = {}) override;
      ...
      //virtual character_count get_window_text(::i8 * pszStringBuf, character_count nMaxCount) override;
      ...
      virtual void Print(::draw2d::graphics_pointer& pdraw2dgraphics, ::u32 dwFlags);
      virtual void PrintClient(::draw2d::graphics_pointer& pdraw2dgraphics, ::u32 dwFlags);
      ...
      //virtual void design_window_full_screen(const ::i32_rectangle & rectangleHint = nullptr) override;
...
//#endif   // WINVER >= 0x0500
      ...
      //      virtual ::user::interaction * WindowFromPoint(const ::i32_point & point);
      ...
      //virtual void message_box(const ::scoped_string & scopedstrText, const ::scoped_string & scopedstrTitle = nullptr, ::u32 nType = e_message_box_ok, const function_arg & functionarg = function_arg());
