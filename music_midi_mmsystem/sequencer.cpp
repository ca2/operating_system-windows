   ...
   namespace midi
   {
      ...
      namespace mmsystem
      {
         ...
         void     sequencer::start_mmsystem_sequencer()
         {
            ...
            if (m_hstream == nullptr)
            {
               ...
               if (estatus != ::success)
               {
                  ...
                  informationf("midiStreamProperty() -> %04X", (WORD)estatus.as_long_long());
         ...
         void sequencer::install_message_routing(::channel * pchannel)
         {
            ...
            //USER_MESSAGE_LINK(MM_MOM_DONE, pchannel, this, &sequencer::_001OnMidiOutDone);
            //USER_MESSAGE_LINK(MM_MOM_POSITIONCB, pchannel, this, &sequencer::_001OnMidiOutPositionCB);
         ...
         void sequencer::stop(player_command * pcommand)
         {
            ...
            if (m_hstream != nullptr)
            {
               ...
               if (::success != m_psequence->m_estatusLastError)
               {
                  ...
                  warning() <<"::music::midi::sequencer::stop -> midiStreamStop returned %lu", (unsigned int)m_psequence->m_estatusLastError.as_long_long();
                  ...
                  else
                  {
                     ...
                     try
                     {
                        ...
                        if (!estatus)
                        {
                           ...
                           warning() <<"midiStreamPosition() returned :" << estatus.as_long_long();
                  ...
                  else
                  {
                     ...
                     try
                     {
                        ...
                        if (::success != estatus)
                        {
                           ...
                           informationf("midiStreamPosition() returned %lu", (unsigned int)estatus.as_long_long());
         ...
         ::e_status sequencer::fill_buffer(LPMIDIHDR lpmidihdr)
         {
            ...
            if (lpmidihdr->dwBufferLength - lpmidihdr->dwBytesRecorded > 16)
            {
               ...
               default:
                  ...
                  informationf("smfReadEvents returned %lu in callback!", (unsigned int)estatus.as_long_long());
         ...
         void sequencer::OnDone(HMIDISTRM hmidistream, LPMIDIHDR lpmidihdr)
         {
            ...
            else
            {
               ...
               default:
                  ...
                  information() << "sequencer::fill_buffer returned %lu", (unsigned int)estatus.as_long_long();
               ...
               if (m_hstream != nullptr && m_psequence->get_state() == sequence::e_state_playing)
               {
                  ...
                  else
                  {
                     ...
                     information() << "e_event_midi_stream_out : midiStreamOut returned %lu", (unsigned int)estatus.as_long_long();
         ...
         */
         ...
         void sequencer::close_device()
         {
            ...
            if (!estatus)
            {
               ...
               informationf("midiOutUnprepareHeader failed in seqBufferDone! (%lu)", (unsigned int)estatus.as_long_long());
         ...
         )
         {
            ...
            if (!estatus)
            {
               ...
               warning() <<"smfInsertParmData[2] : " << estatus.as_long_long();
         ...
         ::e_status sequencer::WorkStreamRender(LPMIDIHDR lpmh, musical_tick tickMax, int iBufferNominalMax)
         {
            ...
            if (m_psequence->m_pfile->m_dwPendingUserEvent)
            {
               ...
               if (!estatus)
               {
                  ...
                  warning() <<"smfInsertParmData() -> : " << estatus.as_long_long();
