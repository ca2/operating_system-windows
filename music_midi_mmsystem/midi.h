   ...
   namespace midi
   {
      ...
      namespace mmsystem
      {
         ...
         public:
            ...
            virtual void     midi_in_translate_os_result(string & strMessage, string & strOsMessage, ::music::midi::object * pobject, i64 iOsResult, const ::string & strContext, const ::string & strText);
