...
namespace draw2d_gdi
{
   ...
   public:
      ...
      i32_point SetBrushOrg(int x, int y) override;
   ...
   public:
      ...
      // Viewport Origin
      virtual i32_point SetViewportOrg(int x, int y) override;
      ...
      virtual ::i32_size SetViewportExt(int cx, int cy) override;
      virtual ::i32_size SetViewportExt(const ::i32_size & size) override;
      virtual ::i32_size ScaleViewportExt(double xNum, double xDenom, double yNum, double yDenom) override;

      // Window Origin
      ::i32_point GetWindowOrg() override;
      ::i32_point SetWindowOrg(int x, int y) override;
      ::i32_point SetWindowOrg(const ::i32_point & point) override;
      ::i32_point offset_window_org(int nWidth, int nHeight) override;

      // Window extent
      ::i32_size GetWindowExt() override;
      virtual ::i32_size set_window_ext(int cx, int cy) override;
      ::i32_size set_window_ext(const ::i32_size & size) override;
      virtual ::i32_size scale_window_ext(int xNum, int xDenom, int yNum, int yDenom) override;
      ...
      int ExcludeClipRect(const ::i32_rectangle & rectangle) override;
      int ExcludeUpdateRgn(::user::prototype * pwindow);
      int IntersectClipRect(int x1, int y1, int x2, int y2) override;
      int IntersectClipRect(const ::i32_rectangle & rectangle) override;
      ...
      bool draw(const ::i32_rectangle & rectangle, ::draw2d::graphics * pgraphicsSrc, const ::i32_point & lppt, unsigned int dwRop) override;
      ...
      virtual bool ExtTextOut(int x, int y, UINT nOptions, const ::i32_rectangle & rectangle, const ::scoped_string & scopedstrString, ::collection::count nCount, INT * lpDxWidths) override;
      virtual bool ExtTextOut(int x, int y, UINT nOptions, const ::i32_rectangle & rectangle, const ::scoped_string & scopedstr, INT * lpDxWidths) override;
      virtual ::i32_size TabbedTextOut(int x, int y, const ::scoped_string & scopedstrString, character_count nCount, ::collection::count nTabPositions, INT * lpnTabStopPositions, int nTabOrigin) override;
      virtual ::i32_size TabbedTextOut(int x, int y, const ::scoped_string & scopedstr, ::collection::count nTabPositions, INT * lpnTabStopPositions, int nTabOrigin) override;
      ...
      // Scrolling Functions
      bool ScrollDC(int dx, int dy, const ::i32_rectangle & lpRectScroll, const ::i32_rectangle & lpRectClip,
