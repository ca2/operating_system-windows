...
namespace win32
{
   ...
   public:
      ...
      iptr send_message(const ::atom & atom, wparam wparam = 0, lparam lparam = 0);
      iptr send_message_w(const ::atom & atom, wparam wparam = 0, lparam lparam = 0);
      void post_message(const ::atom & atom, wparam wparam = 0, lparam lparam = 0);
