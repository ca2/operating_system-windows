...
namespace production
{
   ...
   void view::install_message_routing(::channel * pchannel)
   {
      ...
      IGUI_MSG_LINK(WM_KEYDOWN, pchannel, this, &view::_001OnKeyDown);
      IGUI_MSG_LINK(WM_KEYUP, pchannel, this, &view::_001OnKeyUp);
      ...
      IGUI_MSG_LINK(WM_USER, pchannel, this, &view::_001OnUser);
   ...
   void view::update(::update * pupdate)
   {
      ...
      else if(pupdate->m_id == id_clean)
      {

         m_pproduction->m_bClean = pupdate->value(id_clean);

      }
      else if(pupdate->m_id == id_build)
      {

         m_pproduction->m_bBuild = pupdate->value(id_build);
