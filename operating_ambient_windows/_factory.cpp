...
__FACTORY_EXPORT void operating_ambient_windows_factory(::factory::factory * pfactory)
{
   ...
   pfactory->add_factory_item < ::operating_ambient_windows::node, ::platform::node >();
