...
namespace draw2d_gdiplus
{
   ...
   public:
      ...
      void update_bitmap_as_render_target(
         ::draw2d::domain * pdraw2ddomain = nullptr, ::draw2d::graphics * pdraw2dgraphics = nullptr) override;

      void create_from_data(const ::pixmap_t & pixmap, ::draw2d::domain* pdraw2ddomain, ::enum_flag eflagCreate = DEFAULT_CREATE_IMAGE_FLAG, bool bPreserve = false) override;
