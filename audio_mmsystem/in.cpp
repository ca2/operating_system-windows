...
//      return true;
   ...
   void in::pre_translate_message(::message::message * pmessage)
   {
      ...
      //ASSERT(GetMainWnd() == nullptr);
      if(pmessage->m_eusermessage == MM_WIM_OPEN ||
         pmessage->m_eusermessage == MM_WIM_CLOSE ||
         pmessage->m_eusermessage == MM_WIM_DATA)
      {
   ...
   void in::translate_in_message(::message::message * pmessage)
   {
      ...
      ASSERT(pmessage->m_eusermessage == MM_WIM_OPEN || pmessage->m_eusermessage == MM_WIM_CLOSE || pmessage->m_eusermessage == MM_WIM_DATA);

      if(pmessage->m_eusermessage == MM_WIM_DATA)
      {
