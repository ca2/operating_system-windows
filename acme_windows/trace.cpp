...
//   DEFINE_MESSAGE(e_message_non_client_calc_size),
//   DEFINE_MESSAGE(e_message_non_client_hit_test),
...
//            pMsg->lParam);
...

      {
         ...
         // acmesystem() clipboard formats have other ranges, but no printable
         // format names.
      }
