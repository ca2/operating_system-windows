...
//
//bool CLASS_DECL_ACME_WINDOWS windows_full_path(wstring & wstrFullPath,const wstring & wstrPath);
//
//namespace windows
//{
//
...
//
//// turn a file, relative path or other into an absolute path
//bool CLASS_DECL_ACME_WINDOWS windows_full_path(unichar * pszPathOut, const unichar * pszFileIn)
//
//// pszPathOut = buffer of _MAX_PATH
//
//// pszFileIn = file, relative path or absolute path
