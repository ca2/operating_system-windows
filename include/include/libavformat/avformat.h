...
#define MAX_STD_TIMEBASES (30*12+30+3+6)
    ...
    struct {
        ...
        int64_t time_gcd;
        int time_count;
        int64_t rfps_time_sum;
        double (*time_error)[2][MAX_STD_TIMEBASES];
        int64_t codec_info_time;
        int64_t codec_info_time_fields;
...
#define MAX_REORDER_DELAY 16
    ...
    int64_t interleaver_chunk_time;
    ...
    /**
     * Internal data to prevent doing update_initial_times() twice
     */
    int update_initial_times_done;
