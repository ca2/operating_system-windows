...
#define FT_CONFIG_OPTION_INCREMENTAL
  ...
  /**************************************************************************
   *
   * The i32_size in bytes of the render pool used by the scan-line converter to
   * do all of its work.
   */
...
/* #define CFF_CONFIG_OPTION_OLD_ENGINE */
   ...
   * style changes often if one changes the i32_size and one cannot select some
...
#define AF_CONFIG_OPTION_USE_WARPER
  ...
  /**************************************************************************
   *
   * Use TrueType-like i32_size metrics for 'light' auto-hinting.
   *
   ...
   *
   *     [truetype] Fix metrics on i32_size request for scalable fonts.
   * ```
   *
