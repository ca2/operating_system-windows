...
#define SRB_ENABLE_RESIDUAL_COUNT 0x04   /* Enable residual unsigned char count     */
                                         /* reporting                      */
...
#define SS_ASPI_IS_BUSY           0xE5   /* No resources available to      */
                                         /* execute command                */
#define SS_BUFFER_TO_BIG          0xE6   /* buffer i32_size too big to handle  */
...
typedef struct {
  ...
  BYTE     SRB_Status;        /* 01/001 ASPI command status unsigned char           */
