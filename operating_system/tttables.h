...
FT_BEGIN_HEADER
  ...
  /*                             reference) glyphs in a reference glyph.   */
  /*                                                                       */
  /*    maxComponentDepth     :: The maximum nesting depth of reference    */
  /*                             glyphs.                                   */
  /*                                                                       */
  /* <Note>                                                                */
  ...
  *
  *   tag ::
  *     The four-unsigned char tag of the table to load.  Use the value~0 if you want
  *     to access the whole font file.  Otherwise, you can use one of the
  *     definitions found in the @FT_TRUETYPE_TAGS_H file, or forge a ___new
  ...
  *     table's (or file) full int_size in it.
  *
  ...
  *   int_size (e.g. 32bit vs. 64bit) or order (big endian vs. little endian).
  *
  */
  FT_EXPORT( FT_Error )
