   ...
   void control::OnMixerControlChange()
   {
      ...
      if (m_mixercontrol.dwControlType == MIXERCONTROL_CONTROLTYPE_VOLUME)
      {
         ...
         if (cChannels == 2)
         {
            ...
            //::f64 dActualBalance = pslBalance->GetPos();

            ::f64 dActualBalance = balance_get_position();
            ...
            ::f64 dRangeSlack = nMaxValue == 0 ?
               nRange / 2 :
               ((::f64)nRange) / (2 * nMaxValue) + 0.5;
         ...
         else if (cChannels == 1)
         {
            ...
            //::i32 iGetPos = pslVolume->GetPos();
            
            ::i32 iGetPos = (::i32) volume_get_position();
               ...
               if (nullptr != (pData = GetWindowData(::audio_mixer::control_data::TypeStereoVolume)))
               {
                        ...
                        pData->get_type() == ::audio_mixer::control_data::TypeStereoVolume)
                  {
                     ...
                     if (m_mixercontroldetails.cChannels == 2)
                     {
                        ...
                        ::i32 nBalance = (::i32) balance_get_position();

                        //::i32 nMaxValue = nRange - pslVolume->GetPos();

                        ::i32 nMaxValue = nRange - (::i32) volume_get_position();
                     ...
                     else if (m_mixercontroldetails.cChannels == 1)
                     {
                        ...
                        ::i32 nValue = nRange - (::i32) volume_get_position();
