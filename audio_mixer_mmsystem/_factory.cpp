...
//         /*add_factory_item <user::label                 >  (__type(::audio_mixer::user::label));
//         add_factory_item <user::interaction               >  (__type(::audio_mixer::user_control));
//         add_factory_item <user::level_control         >  (__type(::audio_mixer::user::level_control));
//         add_factory_item <user::toggle_control        >  (__type(::audio_mixer::user::toggle_control));*/
//
//      }
//
//
...
__FACTORY_EXPORT void audio_mixer_mmsystem_factory(::factory::factory * pfactory)
{
   ...
   pfactory->add_factory_item <::audio_mixer_mmsystem::audio_mixer, ::audio_mixer::audio_mixer >();
            //add_factory_item < department, ::audio_mixer::font >();
