...
namespace audio_mixer_mmsystem
{
   ...
   void interaction::_001OnMixerControlChange(::message::message * pmessage)
   {
      ...
      paudiomixer->OnMixerControlChange((HMIXER)pmessage->m_wparam.m_wparam, (unsigned int)pmessage->m_lparam);
   ...
   void interaction::_001OnMixerLineChange(::message::message * pmessage)
   {
      ...
      paudiomixer->OnMixerLineChange((HMIXER)pmessage->m_wparam.m_wparam, (unsigned int)pmessage->m_lparam);
