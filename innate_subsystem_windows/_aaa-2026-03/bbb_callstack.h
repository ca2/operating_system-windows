...
namespace windows
{
   ...
   public:
      ...
      callstack(const ::scoped_string & scopedstrFormat = default_format(), ::i32 iSkip = CALLSTACK_DEFAULT_SKIP_TRIGGER, void* caller_address = nullptr, ::i32 iCount = -1);
      virtual ~callstack();
      ...
      //bool stack_trace(CONTEXT*, iptr iSkip = 0, const ::scoped_string & scopedstrFormat = default_format(), ::i32 iCount = -1);
      //bool stack_trace(iptr iSkip = 1, const ::scoped_string & scopedstrFormat = default_format(), ::i32 iCount = -1);
      //bool stack_trace(CONTEXT*, iptr iSkip = 1, bool bSkip = false, const ::scoped_string & scopedstrFormat = default_format(), ::i32 iCount = -1);
      //::i8* stack_trace(OS_DWORD* pinteraction, ::i32 c, const ::scoped_string & scopedstrFormat = default_format(), ::i32 iCount = -1);
