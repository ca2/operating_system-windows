...
virtual public window_implementation<innate_subsystem::ToolbarInterface, Control>
   ...
   public:
      ...
      void setViewAutoButtons(::i32 iButton, ::i32 style) override;
      ...
      void loadToolbarfromRes(::u32 id) override;
      ...
      void setButtonsRange(::u32 id) override;
      ...
      // or false otherwise.
      bool create(::i32 tbID, const ::operating_system::window & windowParent,
           ::u32 dwStyle = WS_CHILD | WS_VISIBLE | TBSTYLE_FLAT) override;
      ...
      // or -1 otherwise.
      LRESULT addBitmap(::i32 nButtons, ::u32 bitmapID) override;
      ...
      LRESULT addSystemBitmap(::u32 stdBitmapID) override;

      // addNButton() adds nButtons buttons to a toolbar.
      bool addNButton(::i32 nButtons, ::innate_subsystem::toolbar_button_t * ptoolbarbutton) override;

      // addButton() adds one button.
      bool addButton(::i32 iBitmap, ::i32 idCommand, ::u8 state=TBSTATE_ENABLED,
                     ::u8 style=TBSTYLE_BUTTON,  ::u32 dwData=0, ::i32 iString=0) override;

      // checkButton() checks or unchecks a given button in a toolbar control.
      bool checkButton(::i32 idButton, bool check) override;

      // enableButton() enables or disables the specified button
      // in the toolbar.
      bool enableButton(::i32 idButton, bool enable) override;

      // pressButton() presses or releases the specified button in the toolbar.
      bool pressButton(::i32 idButton, bool press) override;

      // getButtonRect() gets the bounding rectangle of a button in a toolbar.
      bool getButtonRect(::i32 nIndex, ::i32_rectangle & rectangle) override;
