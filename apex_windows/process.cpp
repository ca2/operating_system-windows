...
namespace apex_windows
{
   ...
   bool process::create_child_process(const ::string & pszCmdLine, bool bPiped, const ::string & strDir, ::enum_priority epriority)
   {
      ...
      //         if(!::CreateProcess(nullptr, (char *) (const ::string &) m_papplication->m_papexcontext->dir().appdata("production\\build.bat"), nullptr, nullptr, false, CREATE_NEW_CONSOLE, nullptr, nullptr, &si, &pi))
