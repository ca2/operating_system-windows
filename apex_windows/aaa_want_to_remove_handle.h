...
// Operations
public:
   CT * from_handle(HANDLE h, CT * (* pfnAllocator) (__pointer(::application), HANDLE) = nullptr, __pointer(::application) papp = nullptr);
   void delete_temp();
...
template < class HT, class CT >
CT* handle_map < HT, CT >::from_handle(HANDLE h, CT * (*pfnAllocator) (__pointer(::application), HANDLE), __pointer(::application) papp)
{
