...
namespace typeface_gdiplus
{
   ...
   class CLASS_DECL_TYPEFACE_GDIPLUS graphics :
...
//      ::windowing::window * GetWindow() const;
   ...
   public:
      ...
      ::typeface_gdiplus::draw2d * typeface_gdiplus();
...
//                  ::i32 nWidth, ::i32 nHeight, ::draw2d::bitmap& maskBitmap, ::i32 xMask, ::i32 yMask);
      ...
      //virtual ::i32 GetTextFace(::collection::count nCount, ::i8 * lpszFacename);
...
//      bool DrawFrameControl(const ::i32_rectangle & rectangle,::u32 nType,::u32 nState);
      ...
      ::i32 Escape(::i32 nEscape, ::i32 nInputSize,  const_char_pointer pszInputData,::i32 nOutputSize, ::i8 * lpszOutputData);
...
//      virtual bool attach(void * pdata);
   ...
   CLASS_DECL_TYPEFACE_GDIPLUS graphics * thread_graphics();

   CLASS_DECL_TYPEFACE_GDIPLUS void thread_graphics(graphics * graphics);
