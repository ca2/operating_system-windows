...
namespace typeface_gdiplus
{
   ...
   {
      //return dynamic_cast < palette * > (::typeface_gdiplus::object::from_handle(papp, hPalette));
      return nullptr;
   }
   ...
   {
      //ASSERT(pgraphics != nullptr && (dynamic_cast<::typeface_gdiplus::graphics * >(pgraphics))->get_handle1() != nullptr);
      //return attach(::CreateHalftonePalette((dynamic_cast<::typeface_gdiplus::graphics * >(pgraphics))->get_handle1()));
      return false;
