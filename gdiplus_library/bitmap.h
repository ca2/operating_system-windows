...
//#endif
      ...
      virtual bool host_bitmap(::draw2d::graphics * pdraw2dgraphics, pixmap* ppximap) override;
      virtual void create_bitmap(::draw2d::graphics * pdraw2dgraphics, const ::i32_size & size, void **ppvBits, ::i32 * stride) override;
