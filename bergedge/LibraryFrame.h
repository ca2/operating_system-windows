...
public:
   ...
   void OnNcLButtonDblClk(UINT nHitTest,CPoint i32_point);
   void OnNcLButtonDown(UINT nHitTest,CPoint i32_point);
   void OnNcLButtonUp(UINT nHitTest,CPoint i32_point);
