...
pacmedir->system() / "config/plugin/appfy_beg_debug_box.txt"))
      ...
      if (__argc < 4)
      {
         ...
         os_output_message_box_error("Incorrect Number of Arguments passed to appfy. Expected 3 or 4; passed " + __str(__argc - 1), "", e_message_box_ok);
